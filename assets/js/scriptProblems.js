...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const problems = [
        { name: "2spooky4me", link: "https://dmoj.ca/problem/2spooky4me" },
    ...
    problems.forEach(problem => {
        ...
        button.onclick = () => {
            window.location.href = `problemTemplate.html?name=${encodeURIComponent(problem.name)}&link=${encodeURIComponent(problem.link)}`;
